...
//    if ([USER_SINGLE isLogin]) {
//    [dic setObject:USER_SINGLE.token forKey:@"token"];
    if ([urlStr isEqualToString:SH_UPLOAD_ENTREPRISE_LOGO]||[url isEqualToString:SH_ADD_PRODUCTION]) {
        [dic removeObjectForKey:@"token"];
    }
//    }
