...
- (void)defaultLayout
{
    ...
    NSLog(@"%@",config.faceGroups[0]);
//    TFaceGroup *group = config.faceGroups[0];
    self.faceGroups = config.faceGroups;
    [self setData:config.faceGroups];
...
//    NSArray *faceArray = self.faceGroups
    for (NSInteger groupIndex = 0; groupIndex < self.faceGroups.count; ++groupIndex) {
