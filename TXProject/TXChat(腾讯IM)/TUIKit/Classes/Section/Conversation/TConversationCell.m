...
{
    _data = data;
    if ([_data.head containsString:@"https"]) {
        [_headImageView sd_setImageWithURL:[NSURL URLWithString:_data.head] placeholderImage:[UIImage imageNamed:TUIKitResource(@"default_head") ]];
    }else{
